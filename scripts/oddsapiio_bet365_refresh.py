...
def push_files(files_payload: dict, github_token: str) -> int:
    ...
    Reduces file count across all 3 oddsapiio scripts (bet365/bovada/
    fanduel) sharing this one combined file.
    """
    ...
    lock_token = acquire_lock(GIST_ID, github_token, "oddsapiio_combined", holder="bet365")
    if not lock_token:
