    ...
    if source_name == "VegasInsider":
        ...
        for row in rows:
            ...
            if len(cols) >= 3:
                ...
                # Split merged spread values like "-1.5-105" → spread: -1.5, odds: -105
                ...
                if 'o' in total_raw.lower() or 'u' in total_raw.lower():
                    ...
                    if total_match:
                        ...
                        total_odds = total_match.group(3)
        ...
        if not results:
            for block in soup.select(".vi-container .odds-block"):
                ...
                if teams:
                    results.append({
                        "matchup": " vs ".join(clean_team_name(t.get_text(strip=True)) for t in teams),
