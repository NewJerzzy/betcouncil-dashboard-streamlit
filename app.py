...
def load_sport_data(sport):
    ...
    def _pf_pinnacle_lines(): return fetch_pinnacle_game_lines(sport)
    ...
    _parallel_fns = [
        ...
        _pf_nba_advanced, _pf_pinnacle_props, _pf_pinnacle_lines,
    ...
    (pp_props, ud_props_compare, dk_salaries, pinnacle_data,
     ...
     nba_advanced_raw, pinnacle_props_raw, pinnacle_lines_raw,
