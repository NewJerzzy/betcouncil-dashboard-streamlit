...
GAME_SOURCES = {
    ...
    "DraftKings (Failover)": "https://sportsbook.draftkings.com/leagues/{dk_sport}/game-lines",
    "Covers (Failover)": "https://www.covers.com/{sport}/odds",
}
