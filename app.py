...
# fetch_auto_scraped_props — moved to scrapers.py
...
# fetch_fanduel_direct — moved to scrapers.py
...
# fetch_weather_for_game — moved to scrapers.py
...
# fetch_todays_referees — moved to scrapers.py
...
# fetch_soccer_rolling_averages — moved to scrapers.py
...
# fetch_underdog_props — moved to scrapers.py
...
# fetch_cbs_injuries — moved to scrapers.py
...
# fetch_alt_lines — moved to scrapers.py
...
# fetch_espn_game_ids — moved to scrapers.py
# fetch_espn_line_movement — moved to scrapers.py
...
# fetch_espn_predictor — moved to scrapers.py
# fetch_espn_player_gamelogs — moved to scrapers.py
...
# fetch_player_id_bdl — moved to scrapers.py
...
# fetch_mlb_confirmed_lineups — moved to scrapers.py
# fetch_draftkings_direct — moved to scrapers.py
# fetch_betmgm_direct — moved to scrapers.py
# fetch_caesars_direct — moved to scrapers.py
# fetch_betrivers_direct — moved to scrapers.py
...
# fetch_nfl_practice_participation — moved to scrapers.py
...
# fetch_nfl_inactives — moved to scrapers.py
...
# fetch_nhl_starting_goalies — moved to scrapers.py
