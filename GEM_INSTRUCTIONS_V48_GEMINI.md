# BetCouncil GEM Instructions v4.8 — Gemini Edition
# Note: Gemini has 1M token context — paste full brief without truncation.
# Updated: June 2026 — ParlayAPI EV, Action Network %, Unabated, Kambi books (HardRock/WynnBet/Unibet/Bet365), OpenMeteo, Ump Scorecards
...
**Sportsbooks (direct scraper):** DraftKings, BetMGM, Bovada, BetOnline
**Sportsbooks (via Kambi API):** HardRock, WynnBet, Unibet, Bet365 ✅ NEW
...
**Sharp line tools:** Unabated (Pinnacle-based fair lines, free) ✅ NEW
**Public betting %:** Action Network (free, real-time) ✅ NEW
**Props aggregator:** OddsPAPI via The Odds API (DK/FD/BetMGM props) ✅ NEW
**ParlayAPI:** +EV picks vs Pinnacle baseline + arbitrage scanner ✅ NEW
**Total: 25+ books/sources**
